...
function origin_scripts() {
	wp_enqueue_style( 'origin-style', get_stylesheet_uri(), array(), _S_VERSION );
	wp_style_add_data( 'origin-style', 'rtl', 'replace' );

	wp_enqueue_script( 'origin-navigation', get_template_directory_uri() . '/js/navigation.js', array(), _S_VERSION, true );
