# CUSTOM DEPLOYMENT FOR ORIGIN

On a git push, both the GitHub repo, and the remote Pantheon instance are updated with the same code. This is configured in the peoject directory at wp-drop/.git/config, line 8.
